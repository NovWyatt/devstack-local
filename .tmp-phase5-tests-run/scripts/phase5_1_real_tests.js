...
const remote_service_1 = require("../electron/services/remote.service");
class MemoryStorage {
    constructor() {
        this.connections = [];
        this.secrets = [];
...
function createHarness(behaviors, connectTimeoutMs = 150) {
    ...
    const clients = [];
    const service = new remote_service_1.RemoteService(bridge, {
        storage,
...
async function main() {
    ...
    const outputPath = path_1.default.join(projectRoot, 'phase5_1_test_results.json');
